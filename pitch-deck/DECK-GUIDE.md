# PNEUOMA Pitch Deck Guide

## Using the HTML Deck

Open `index.html` in a browser for the best experience:

- **Navigate**: Arrow keys, spacebar, or click left/right halves
- **Fullscreen**: Press `F` or use browser fullscreen (F11)
- **Mobile**: Swipe left/right
- **Export to PDF**: Print (Cmd+P) → Save as PDF

---

## Recreating in PowerPoint/Keynote
...
| Accent Primary | `#64ffda` | Headlines, numbers |
| Accent Secondary | `#06b6d4` | Gradients |
| Accent Warm | `#ff6b9d` | Special highlights |
...
1. **Dark backgrounds** throughout — matches brand
2. **Accent color for numbers** — draws attention to stats
3. **Generous whitespace** — let content breathe
4. **Subtle animations** — fade in, not flashy
5. **Consistent card style** — rounded corners (16px), subtle background
